...
public class GmailLoginKeywordDriven {
	
	@Test
	public void loginTest() throws IOException, InterruptedException
	{
		FileInputStream  f1=new FileInputStream("E:\\May25\\WebdriverProject\\Gmail.properties");
		Properties pr=new Properties();
		pr.load(f1);
		LoginKeywords keys=new LoginKeywords();
		FileInputStream f=new FileInputStream("E:\\May25\\WebdriverProject\\src\\com\\qedge\\keywords\\LoginKeywords.xlsx");
