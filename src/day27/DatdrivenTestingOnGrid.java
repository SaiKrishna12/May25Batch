...
public class DatdrivenTestingOnGrid {
	@Parameters("browser")
	@Test
	public void linkTest(String b) throws IOException
	{
		...
		FileInputStream f=new FileInputStream("E:\\May25\\WebdriverProject\\src\\com\\qedge\\excelfiles\\links.xlsx");
		...
		FileOutputStream f1=new FileOutputStream("E:\\May25\\WebdriverProject\\src\\com\\qedge\\resultexcelfiles\\"+b+"_links.xlsx");
		wb.write(f1);
		f1.close();
